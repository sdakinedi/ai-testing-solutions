...
def rag_query(
    ...
    persist_directory: str = "C:\\Users\\Satyaprasad_Dakinedi\\Desktop\\LangChain_demos\\langchaindemos\\vectorstore_02") -> str:
    """
...
@mcp.tool()
def evaluate_rag(test_breadth: int = 2, test_depth: int = 3, launch_dashboard=True, dashboard_port=8501) -> str:
    """
    Evaluate the RAG chain using TruLens with synthetic test data.
