...
class RAGSystem:
    ...
    def initialize(self, pdf_path: str, persist_directory: str):
        ...
        print("Response for default question after initialization is:", response)

        self.is_initialized = True
        print(f"Initializing RAG System with: {pdf_path}, {persist_directory}")
...
def rag_query(
    ...
    persist_directory: str = "C:\\Users\\Satyaprasad_Dakinedi\\Desktop\\AI_Solutions_Implementations\\MCP\\agentic-rag-mcp\\rag_vector_store4"
) -> str:
    """
...
if __name__ == "__main__":
    ...
    try:
        # Test query
        result = rag_query("What is the role of the Scrum Master in a Scrum team?")
        ...
        # Test with a question that might not be in the document
        result2 = rag_query("Who is the prime minister of India?")
        print(f"Out-of-context Query Result: {result2}")
